...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, required=True, default='', help='dataset type')
    ...
    parser.add_argument('--num_p', type=int, default=6, help='num of down sampled patches')
    ...
    #CarbonMix
    parser.add_argument('--var_rank', type=int, default=4, help='rank for variable mixing')
    parser.add_argument('--ctx_len', type=int, default=8, help='context length for variable mixing')
    args = parser.parse_args()
    # Configure CUDA visibility BEFORE any torch.cuda queries
    ...
    # Determine GPU availability after setting CUDA_VISIBLE_DEVICES
